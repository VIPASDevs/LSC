...
public class lscde {
	public static void main(String[] args) {
		JFrame frame = new JFrame("LSC – GUI-Alpha");
		...
		JLabel options = new JLabel("ADDITION [+], SUBTRAKTION [-], MULTIPLIKATION [*], DIVISION [/]");
		...
		frame.add(new JLabel("BETRIEB: "));
		frame.add(choice);
		
		frame.add(new JLabel("NUMMER 1: "));
		frame.add(num1);
		
		frame.add(new JLabel("NUMMER 2: "));
		frame.add(num2);
